    ...
    if msgs > max_msg then
	  ...
	  if msg.to.type == 'chat' or msg.to.type == 'channel' then
		if username then
			...
			send_large_msg(receiver , "🚩کاربر @"..username.."["..msg.from.id.."] به دلیل اسپم از گروه اخراج شد!\n🚫نوع پیام "..msg.type.."")
		else
			savelog(msg.to.id, name_log.." ["..msg.from.id.."] kicked for #spam")
			send_large_msg(receiver , "🚩کاربر:"..name_log.."["..msg.from.id.."] به دلیل اسپم از گروه اخراج شد!\n🚫نوع پیام "..msg.type.."")
		end
	  end
      -- incr it on redis
      ...
      if gbanspamonredis then
        if tonumber(gbanspamonredis) ==  4 and not is_owner(msg) then
          ...
          send_large_msg("chat#id"..msg.to.id, "🚩کاربر [ "..name.." ]"..msg.from.id.." از بودن در تمام گروه ها با مگا تسلا ممنوع شد!\nدلیل : اسپم کردن")
		  send_large_msg("channel#id"..msg.to.id, "🚩کاربر [ "..name.." ]"..msg.from.id.." از بودن در تمام گروه ها با مگا تسلا ممنوع شد!\nدلیل : اسپم کردن")
          local GBan_log = 'GBan_log'
		  local GBan_log =  data[tostring(GBan_log)]
		  for k,v in pairs(GBan_log) do
			log_SuperGroup = v
			gban_text = "🚩کاربر [ "..name.." ] ( @"..username.." )"..msg.from.id.." از بودن در تمام گروه ها با مگا تسلا ممنوع شد!\nدلیل : اسپم کردن ( "..msg.to.print_name.." ) [ "..msg.to.id.." ] (#اسپم)"
